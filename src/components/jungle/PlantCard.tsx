  ...
  return (
    <>
      <article
        ...
        className="bento-card rounded-2xl overflow-hidden border border-[#e6f4f2] dark:border-[#354545] group hover:shadow-xl transition-all duration-300 flex flex-col opacity-0 cursor-pointer"
      >
        <div className="h-64 relative overflow-hidden">
          ...
          <button 
            ...
            className="absolute bottom-3 right-3 p-2 bg-white/20 hover:bg-white text-white hover:text-primary rounded-full backdrop-blur-md transition-all opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 z-10"
          >
      ...
      {/* Plant Details Modal */}
      {showModal && (
        <PlantDetailsModal plant={plant} onClose={() => setShowModal(false)} />
      )}
    </>
  );
}
