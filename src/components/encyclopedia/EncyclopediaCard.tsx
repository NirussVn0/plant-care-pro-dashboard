...
export default function EncyclopediaCard({ plant }: EncyclopediaCardProps) {
  return (
    <div className="bento-card rounded-xl overflow-hidden border border-[#e6f4f2] dark:border-[#354545] group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
      <div className="h-56 relative overflow-hidden">
        ...
        <button className="absolute bottom-3 right-3 p-2 bg-white/20 backdrop-blur-md rounded-full text-white hover:bg-white hover:text-primary transition-all opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0">
