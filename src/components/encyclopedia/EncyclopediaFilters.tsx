    ...
    <aside className="lg:col-span-3 space-y-6">
      <div className="bento-card rounded-xl p-6 border border-white dark:border-[#354545]">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="text-xs font-bold text-primary hover:text-[#005f52]">
            Reset All
          </button>
        </div>
        ...
        <div className="space-y-4 mb-8">
          ...
          {["Succulents", "Tropical", "Ferns", "Cacti", "Flowering"].map(
            (cat) => (
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="flex flex-col gap-2">
            {[
              ...
              >
                <span className="font-medium text-text-main dark:text-text-inverse">
                  {level.label}
                </span>
                <span className={`size-2 rounded-full ${level.color}`}></span>
              </button>
            ))}
          </div>
        </div>
